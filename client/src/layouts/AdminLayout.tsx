        ...
        <div className='flex'>
          ...
          >
            <header className='flex items-center flex-col justify-center py-16 bg-gray-800 relative'>
              ...
              />
              <Spacer y={4} />
              <h2 className=' text-gray-400 font-bold text-sm'>Bienvenido, {user.name}</h2>
              <Spacer y={2} />
              <span className='text-gray-300 font-thin text-xs'>Panel Administrador</span>
              <Spacer y={2} />
              <span className='text-gray-300 font-thin text-xs'>Hotel Waynapicchu</span>
            </header>
            <div className='pt-8'>
              <Listbox
