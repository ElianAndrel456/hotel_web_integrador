	...
	return (
		<main>
			...
			<section className='bg-large-hero-pattern2 bg-[rgba(0,0,0,.8)] bg-blend-darken h-[600px] bg-fixed bg-cover'>
				<div className='px-[300px] py-14 text-white'>
					<span className='uppercase text-xs text-primary'>
						Queremos Saber mas de ti
					</span>
					<h3 className='text-3xl font-semibold'>Contactanos</h3>
					<Spacer y={4} />
					<Divider className='bg-primary h-2 w-10' />
					<Spacer y={4} />
					<div className='max-w-sm flex flex-col'>
						<p>
							Cómo podemos ayudarte? En Waynapicchu Hotel Cusco estamos a tu
							disposición para que tu estadía sea perfecta. Déjanos tus
							comentarios aquí.
						</p>
						<Spacer y={2} />
